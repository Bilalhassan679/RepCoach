...
type Props = NativeStackScreenProps<RootStackParamList, 'BodyWeightGoals'>;

const BodyWeightGoalsScreen: React.FC<Props> = ({navigation}) => {
  const [unit, setUnit] = useState<'lbs' | 'kg'>('lbs');
  const [goal, setGoal] = useState(75);
  const [bodyWeight, setBodyWeight] = useState('75lbs');
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={{paddingHorizontal: wp(5)}}>
        <Text style={styles.title}>Body Weight Goals</Text>
                  ...
                  <TouchableOpacity
                    ...
                    {val !== goal && (
                      <Text
                        style={[
                          styles.rulerValue,
                          val === goal && styles.rulerValueActive,
                        ]}>
                        {val}
                      </Text>
                    )}
                  </TouchableOpacity>
                  {/* Render minor ticks except after the last major tick */}
        ...
        <View style={styles.inputSection}>
          <Text style={styles.inputLabel}>Current body weight ?</Text>
          <TextInput
            style={styles.input}
            value={bodyWeight}
...
export default BodyWeightGoalsScreen;
